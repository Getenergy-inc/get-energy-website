...
export default function LandingImage() {
  return (
    <AttentionSeeker
      ...
      duration={30000}
      effect="shakeY"
      className="md:w-3/5 lg:4/5 xl:w-4/5 2xl:w-4/6 h-full relative z-10"
    >
      <div>
        <>
          <Zoom triggerOnce>
            <Image src={assets.landing_2} alt="landing-img" className="w-full absolute -top-5 left-10" />
            <Image src={assets.landing_1} alt="landing-img" className="w-full relative z-20" />
          </Zoom>
        </>
