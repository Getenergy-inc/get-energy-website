      ...
      <section id="feature-section">
        <div className="mt-40">
          ...
          <div className="container mx-auto gap-12 grid-cols-3 grid">
            <div className="col-span-2 grid grid-cols-3 items-center gap-6 rounded-2xl p-12 bg-[#F5F8FE]">
              ...
              <div className="bg-[#CCD8E2] rounded-[2rem] relative aspect-square"></div>
            </div>
            <div className="rounded-2xl min-h-48 bg-[#F5F8FE] p-10">
              <div className="space-y-4">
                <div className="w-full relative h-32 bg-[#32ACED] rounded-xl"></div>
                <h4 className="text-3xl font-semibold">Effortless Recharge</h4>
                <p>
            ...
            <div className="rounded-2xl min-h-48 bg-[#F5F8FE] p-10">
              <div className="space-y-4">
                <div className="w-full relative h-32 bg-[#FFC173] rounded-xl"></div>
            ...
            <div className="rounded-2xl min-h-48 bg-[#F5F8FE] p-10">
              <div className="space-y-4">
                <div className="w-full relative h-32 bg-[#7D7AFF] rounded-xl"></div>
            ...
            <div className="rounded-2xl min-h-48 bg-[#F5F8FE] p-10">
              <div className="space-y-4">
                <div className="w-full relative h-32 bg-[#F54BC3] rounded-xl"></div>
