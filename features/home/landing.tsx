    ...
    <header id="landing-header" className={`relative ${windowSize > 768 ? "invisible" : ""} overflow-hidden pb-20`}>
      ...
      <div className="w-full flex flex-col md:grid z-[50] container mx-auto grid-cols-5 mt-[3rem] gap-6 items-center">
        <div className="w-full col-span-3 space-y-10">
          ...
          <div>
            <div className="w-full grid mt-4 md:hidden md:place-content-center text-primaryBlue">
              ...
              <MouseIcon className="text-center md:block hidden animate-bounce [animation-duration:1s]" />
            </div>
          </div>
        </div>
      ...
      <div className="w-full md:grid hidden place-content-center text-primaryBlue">
        <div className="text-center space-y-4 text-sm md:text-base">
          ...
          <MouseIcon className="mx-auto animate-bounce [animation-duration:1s]" />
        </div>
      </div>
    </header>
  );
