...
import { TransitionFromBottom, TransitionParentInView } from "@/lib/utils/transitions";
...
export default function Download() {
  ...
  return (
    <div className="w-full relative lg:rounded-3xl bg-white lg:bg-[#003B6D] h-[300px]">
      ...
      />
      <TransitionParentInView className="absolute top-0 left-0 w-full z-20 h-full flex flex-col items-center justify-center">
        <TransitionFromBottom>
          <h5 className="text-sky-800 lg:text-white font-bold text-xl lg:text-3xl mb-4 text-center">
            GetEnergy Mobile App Coming Soon
          </h5>
        </TransitionFromBottom>
        <p className="w-full md:w-4/6 lg:w-2/4 text-xs lg:text-md text-gray-300 text-center px-5">
          Join us on this exciting journey as we empower you to optimize your energy trading strategies, unlock new
          opportunities, and achieve financial success.
        </p>
        <TransitionParentInView className="w-full md:w-6/12 lg:w-4/12 flex items-center justify-between mt-6 px-5">
          <TransitionFromBottom>
            <button
          ...
          >
            <div>
              <div className="bg-white text-dark font-semibold p-3 mb-0 border-b border-solid border-blueGray-100 uppercase rounded-t-lg">
                Coming Soon
              </div>
              <div className="bg-white text-dark p-3">
                Join us on this exciting journey as we empower you to optimize your energy trading strategies, unlock
                new opportunities, and achieve financial success.
              </div>
            </div>
          </div>
