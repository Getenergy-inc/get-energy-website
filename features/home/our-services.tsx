    ...
    <div className='w-full p-2 lg:p-0'>
      <div className="w-full main-bg rounded-xl p-5 md:p-12 flex flex-col lg:flex-row items-center my-10">
        <div className="w-full lg:w-1/3 flex items-center justify-center">
          <h1 className="text-white text-3xl lg:text-5xl border-b-4 border-white">Our Service</h1>
        </div>
        <div className="mt-10 lg:mt-0 w-full lg:w-2/3">
          <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-10">
            {service_data.filter((item) => item._id !== "service-3").map((item) => (
              <div className="w-full rounded-xl p-4 md:p-8 py-12 bg-white" key={item._id}>
                <Image
                  alt="our-service-img"
                  src={item.icon}
                  className="mb-4"
          ...
          <div className="w-full flex justify-center my-10">
            <Link className="rounded-full border border-white p-3 px-10 text-white hover:bg-white hover:text-sky-800" href="/our-services">
              See More
            </Link>
          </div>
        </div>
